...
RSpec.describe LedgerSync::Resource do
  ...
  it do
    customer = test_ledger_module::Customer.new
    expect { customer.subsidiaries = [test_ledger_module::Customer.new] }.to raise_error(
      LedgerSync::Error::ResourceAttributeError::TypeError
    )
  end
