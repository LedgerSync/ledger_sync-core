...
RSpec.describe LedgerSync::Util::ResourcesBuilder do
  context 'with date' do
    ...
    it do
      ...
      expect { builder.resource }.to raise_error(LedgerSync::Error::ResourceAttributeError::TypeError)
    end
  end
  ...
  it do
    h = {
      'customer' => {
        '3aab091a-1a8a-4c96-b86c-f145198da13d' => {
          data: {
            ...
            subsidiary: '928db55e-6552-4aaf-96d7-10c693922b1f',
            subsidiaries: [
      ...
      :subsidiary => {
        ...
        'e337cbce-3765-4a82-8e6f-3f7b960f5d67' => {
          ledger_id: 'e337cbce-3765-4a82-8e6f-3f7b960f5d67',
          data: {}
        }
      }
    }
    ...
    expect(resource.subsidiaries.first).to be_a(LedgerSync::Ledgers::TestLedger::Subsidiary)
